/*
 * Provides typed, build-time database access helpers for game records and
 * their related category and publisher data.
 */
 ...
 *
 * @param db - The database client used to query game records.
